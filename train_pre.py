...
def get_model(model_fn, model_params, path, load_previous=False, parallel=False, gpu_index=None,
              vocabulary=None, has_delimiter=False):
    m = model_fn(
        **model_params
    )
    # to_cuda(m)
...
def load_config_and_run(args):
    ...
    train_and_evaluate(model=model, batch_size=batch_size, train_dataset=train_data, valid_dataset=val_data,
                       ...
                       load_previous=load_previous, is_debug=is_debug, epoch_ratio=epoch_ratio, clip_norm=clip_norm,
                       start_epoch=start_epoch,
                       do_sample_evaluate=do_sample_evaluate, print_output=print_output,
                       ...
                       do_save_records_to_database=do_save_records_to_database,
