...
global_evaluate_disc = False
global_only_predict_masked = False
global_random_mask_position = False
global_train_type = 'only_disc'
...
def pretrain_masked_model1(is_debug):
    ...
    train_type = 'both'
    evaluate_disc = global_evaluate_disc

    if evaluate_disc:
        only_predict_masked = global_only_predict_masked
        random_mask_position = global_random_mask_position
        train_type = global_train_type
...
# [vocabulary, mask_language_model_param, detect_token_model_param, train_type, ignore_id, pad_id, check_error_task]
        ...
        'evaluate_object_list': [MaskedLanguageModelTokenAccuracy(ignore_token=ignore_id, train_type=train_type),
                                 GraphPositionPredictAccuracy(ignore_token=ignore_id, train_type=train_type)],
...
def pretrain_masked_model3(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model3',
        'save_name': 'pretrain_masked_model3.pkl',
        'load_model_name': 'pretrain_masked_model3.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model4(is_debug):
    # pretrain gene config: pretrain_masked_model3_gene20
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model4',
        'save_name': 'pretrain_masked_model4_gene20.pkl',
        'load_model_name': 'pretrain_masked_model4_gene20.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model5(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model5',
        'save_name': 'pretrain_masked_model5.pkl',
        'load_model_name': 'pretrain_masked_model5.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
# [vocabulary, mask_language_model_param, detect_token_model_param, train_type, ignore_id, pad_id, check_error_task]
        ...
        'train_loss': create_loss_fn(ignore_id, check_error_task=check_error_task, train_type=train_type),
        'evaluate_object_list': [MaskedLanguageModelTokenAccuracy(ignore_token=ignore_id, train_type=train_type),
                                 GraphPositionPredictAccuracy(ignore_token=ignore_id, train_type=train_type, check_error_task=check_error_task)],
...
def pretrain_masked_model6(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model6',
        'save_name': 'pretrain_masked_model6.pkl',
        'load_model_name': 'pretrain_masked_model6.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model7(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model7',
        'save_name': 'pretrain_masked_model7.pkl',
        'load_model_name': 'pretrain_masked_model7.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model8(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model8',
        'save_name': 'pretrain_masked_model8.pkl',
        'load_model_name': 'pretrain_masked_model8.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model9(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model9',
        'save_name': 'pretrain_masked_model9_gene20.pkl',
        'load_model_name': 'pretrain_masked_model9_gene20.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
...
def pretrain_masked_model10(is_debug):
    from c_parser.ast_parser import set_ast_config_attribute
    set_ast_config_attribute("add_sequence_link", False)
    ...
    from model.generate_detect_model import create_output_ids_fn
    return {
        'name': 'pretrain_masked_model10',
        'save_name': 'pretrain_masked_model10.pkl',
        'load_model_name': 'pretrain_masked_model10.pkl',
        # 'logger_file_path': 'pretrain_masked_model1.log',
